...
if ($isFilter || $isSidebar): ?>
	<div class="col-md-3 col-sm-4 col-sm-push1-8 col-md-push1-9<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?>">
		<? if ($isFilter): ?>
...
<?endif?>
<div class="<?=(($isFilter || $isSidebar) ? "col-md-9 col-sm-8 col-sm-pull1-4 col-md-pull1-3" : "col-xs-12")?>">
	<div class="row">
		<div class="col-xs-12">
			<?
